        ...
        {externalApps.map((app) => (
          ...
          >
            ...
            <span className="min-w-0 flex-1">
              ...
              <span className="block truncate text-xs font-semibold text-white/70">{app.description}</span>
            </span>
            <ExternalLink className="h-4 w-4 shrink-0 text-white/50 transition-colors group-hover:text-white" strokeWidth={2} />
          </a>
        ))}
      </div>
    </section>
